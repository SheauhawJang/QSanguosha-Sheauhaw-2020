...
return {
	...
	["zhenlve"] = "缜略",
	[":zhenlve"] = "锁定技，①使用者为你的普通锦囊牌不是【无懈可击】的合法目标。②你不是延时锦囊牌的合法目标。",
	["jianshu"] = "间书",
	[":jianshu"] = "限定技，出牌阶段，你可选择一名其他角色A和一名攻击范围内含有其且是A拼点的合法目标的其他角色B，并将一张黑色手牌交给A▶"..
		"A和B拼点。若A：赢，A弃置两张牌；未赢，A失去1点体力。若B：赢，B弃置两张牌；未赢，B失去1点体力。",
	["yongdi"] = "拥嫡",
	[":yongdi"] = "限定技，回合开始后，你可令一名其他男性角色加1点体力上限▶其回复1点体力。若其武将牌上有带有“主公技”标签的技能且其身份不为主公，其获得这些技能。",
	...
	["zhendu"] = "鸩毒",
	[":zhendu"] = "一名角色的出牌阶段开始时，若其存活，你可弃置一张手牌▶其使用无对应的实体牌的【酒】（使用方法①）▷若其不是你，你对其造成1点普通伤害。",
	["@zhendu-discard"] = "你可以弃置一张手牌对 %src 发动“鸩毒”",
	["qiluan"] = "戚乱",
	[":qiluan"] = "一名角色的回合结束前，你可摸（2X+Y）张牌（X为你于此回合内杀死过的角色数，Y为于此回合内死亡的角色数）。",
