...
return {
	...
	["designer:yujin"] = "许坦",
	["zhenjun"] = "镇军",
	[":zhenjun"] = "准备阶段开始时，你可选择一名角色并弃置其X张牌（X=max{其手牌数和体力值之差,1}）▶"..
		"若其以此法被弃置的牌中有不为装备牌的牌，你选择：1.弃置Y张牌；2.令其摸Y张牌。（Y为其以此法被弃置的牌中不为装备牌的牌数）",
	["zhenjun-invoke"] = "是否使用“镇军”，选择一名角色",
	["zhenjun-discard"] = "镇军：请弃置%arg张牌，或点“取消”令%dest摸%arg张牌",
	...
	["xianzhen"] = "陷阵",
	[":xianzhen"] = "出牌阶段限一次，你可与一名角色拼点▶若你：赢，你于此阶段内对其使用牌无距离关系的限制且无视其防具技能且对包括其在内的角色使用牌无次数限制；"..
		"未赢，你于此回合内不能使用【杀】。",
	["jinjiu"] = "禁酒",
