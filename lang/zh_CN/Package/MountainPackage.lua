...
return {
	...
	["dengai"] = "邓艾",
	["tuntian"] = "屯田",
	[":tuntian"] = "当你于回合外失去牌后或你于回合内失去【杀】后，你可以进行判定，当非红桃的判定牌生效后，你将此牌置于你的武将牌上，称为“田”；你计算与其他角色的距离-X（X为“田”的数量）。",
	["#tuntian-dist"] = "屯田",
	["field"] = "田",
	["zaoxian"] = "凿险",
	...
	["jiangwei"] = "姜维",
	["tiaoxin"] = "挑衅",
	[":tiaoxin"] = "出牌阶段限一次，你可以选择一名其他角色，然后除非该角色对你使用一张【杀】，否则你弃置其一张牌。",
	...
	["fangquanask"] = "放权",
	["#fangquan-next"] = "放权",
	[":fangquan"] = "你可以跳过出牌阶段。若如此做，弃牌阶段开始时，你可以弃置一张手牌并选择一名其他角色，然后令其在本回合结束后获得一个额外的回合。",
	["@fangquan-give"] = "你可以弃置一张手牌令一名其他角色进行一个额外的回合",
	["ruoyu"] = "若愚",
	[":ruoyu"] = "主公技，觉醒技，准备阶段开始时，若你是体力值最小的角色（或之一），你加1点体力上限，回复1点体力，然后获得技能“激将”和“思蜀”。",
	["sishu"] = "思蜀",
	[":sishu"] = "出牌阶段开始时，你可以指定一名角色，令其本局游戏中【乐不思蜀】判定效果反转。",
	["@sishu-invoke"] = "是否使用“思蜀”，选择一名角色",
	...
	["hunzi"] = "魂姿",
	[":hunzi"] = "觉醒技，准备阶段开始时，若你的体力值为1，你减1点体力上限，回复一点体力，然后获得技能“英姿”和“英魂”。",
	["zhiba"] = "制霸",
	["zhiba_attach"] = "制霸",
	[":zhiba"] = "主公技，其他吴势力角色的出牌阶段限一次，该角色可以与你拼点，你可以拒绝此拼点，若其没赢，你可以获得此次拼点的两张牌。你的出牌阶段限一次，你可与其他吴势力角色拼点。若其没赢，你可以获得拼点的两张牌。",
	...
	["huashen"] = "化身",
	[":huashen"] ="游戏开始时，你随机将3张游戏外的武将牌扣置于一旁，形成“化身牌堆”（“化身牌堆”里的牌仅对你可见，进入过“化身牌堆”的牌称为“化身牌”），然后选择一张“化身牌”置于武将牌旁。你的性别和势力属性视为与你武将牌旁的“化身牌”相同且你获得该武将牌的一个技能。回合开始时和结束后，你可选择一项：1. 更改亮出的“化身牌”；2. 移去至多2张未亮出的“化身牌”，然后你获得等量的“化身牌”。",
	["xinsheng"] = "新生",
	[":xinsheng"] = "当你受到1点伤害后，你可以随机将一张游戏外的武将牌置入“化身牌堆”。",
	["#GetHuashen"] = "%from 获得了 %arg 张“化身牌”",
	["#GetHuashenDetail"] = "%from 获得了“化身牌” 【%arg】",
	["changeHuashen"] = "更改“化身牌”",
	["recastHuashen"] = "重铸“化身牌”",
	["huashen_change:prompt"] = "是否选择第 %arg 张“化身牌”",
}
