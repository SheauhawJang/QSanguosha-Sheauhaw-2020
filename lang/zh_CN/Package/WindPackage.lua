...
return {
	...
	["qimou"] = "奇谋",
	[":qimou"] = "限定技，出牌阶段，你可以失去任意点体力，你摸X张牌，至其他角色的距离于此回合内-X且你于此回合内使用【杀】的次数上限+X（X为你以此法失去的体力数）。",
	...
	["xiaoqiao"] = "小乔",
	["hongyan"] = "红颜",
	[":hongyan"] = "锁定技，你的黑桃牌或你的黑桃判定牌的花色视为红桃。只要你的装备区有红桃牌，你的手牌上限等于体力上限。",
	["tianxiang"] = "天香",
	[":tianxiang"] = "当你受到伤害时，你可以弃置一张红桃牌并选择一名其他角色。你防止此伤害。选择：1.其受到来源的1点伤害。其摸X张牌（X为其已损失的体力值，且至多为5）；2.其失去1点体力。其获得弃牌堆或牌堆中的此牌。",
