...
return {
	...
	["benxi"] = "奔袭",
	[":benxi"] = "锁定技，①当牌于你的回合内被使用时，若使用者为你，你令你至其他角色的距离于此回合内-1。②当【杀】或普通锦囊牌选择目标后，"..
		"若使用者为你且你为当前回合角色且目标对应的角色数为1且你至所有其他角色的距离均为1，你获得1枚“奔”▶你可选择一至两项：1.令一名角色也成为此牌的目标；"..
		"2.你于此牌的使用流程中无视所有角色的防具；3.令此牌不是牌的合法目标；4.获得1枚“袭”→当一名角色造成伤害时，若渠道为此牌，你摸一张牌。",
	["#benxi-dist"] = "奔袭",
	["@benxi-target"] = "奔袭：可选择一名角色作为【%arg】的额外目标",
	["@benxi-choose"] = "奔袭：请选择一项操作",
	["benxi:extra_target"] = "增加一个目标",
	["benxi:ingore_armor"] = "无视防具",
	["benxi:no_offset"] = "不能被抵消",
	["benxi:draw"] = "造成伤害时摸牌",
