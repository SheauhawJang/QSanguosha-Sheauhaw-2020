...
return {
	...
	["zhengrong"] = "征荣",
	[":zhengrong"] = "当【杀】或伤害类锦囊牌指定第一个目标后，若使用者为你，你可选择是此牌的目标对应的角色且手牌数不小于你的一名角色，你将其一张牌扣置于武将牌上（称为“荣”）。",
	["hongju"] = "鸿举",
	[":hongju"] = "觉醒技，准备阶段开始时，若“荣”数大于2▶你可选择至少一张“荣”和你等量的手牌，将你以此法选择的手牌扣置于武将牌上（均称为“荣”），获得你以此法选择的“荣”，减1点体力上限，获得〖清侧〗。",
	["qingce"] = "清侧",
	[":qingce"] = "出牌阶段，你可获得一张“荣”▶你弃置一张手牌。你弃置一名角色装备区或判定区里的一张牌。",
	["honour"] = "荣",
	["@hongju-exchange"] = "鸿举：是否用手牌交换“荣”（选择%arg张牌作为新的“荣”）",
	["@zhengrong-target"] = "是否使用“征荣”，选择一名角色",
	["@qingce-discard"] = "清侧：选择一张手牌弃置",
	["@qingce-target"] = "清侧：选择一名角色弃置其场上的一张牌",
