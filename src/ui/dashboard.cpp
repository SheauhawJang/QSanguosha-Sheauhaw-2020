...
void Dashboard::updatePending()
{
    ...
    if (view_as_skill->getExpandPile() == "cardcontainer")
        RoomSceneInstance->filterCardContainer(view_as_skill);
...
void Dashboard::externalPending(CardItem *item)
{
    if (pendings.contains(item))
