...
class KofManyi : public TriggerSkill
{
public:
    KofManyi() : TriggerSkill("kofmanyi")
    {
        events << Debut;
    }
    ...
    virtual bool trigger(TriggerEvent, Room *room, ServerPlayer *player, QVariant &) const
    {
        ...
        savage_assault->setSkillName("_kofmanyi");
...
class KofManyiAvoid : public TriggerSkill
{
public:
    KofManyiAvoid() : TriggerSkill("#kofmanyi-avoid")
    {
        events << CardEffected;
    }
    ...
    : Package("Special1v1")
{
    ...
    kof_menghuo->addSkill(new KofManyi);
    kof_menghuo->addSkill(new KofManyiAvoid);
    kof_menghuo->addSkill("zaiqi");
    related_skills.insertMulti("kofmanyi", "#kofmanyi-avoid");

    General *kof_zhurong = new General(this, "kof_zhurong", "shu", 4, false);
    kof_zhurong->addSkill("kofmanyi");
