...
class YanjiaoCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE YanjiaoCard();
    virtual void onEffect(const CardEffectStruct &effect) const;
};
...
class SelfPlayChessPackage : public Package
{
    Q_OBJECT

public:
    SelfPlayChessPackage();
};

class StrategyPackage : public Package
{
    Q_OBJECT
