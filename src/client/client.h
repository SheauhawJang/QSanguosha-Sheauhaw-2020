...
public:
    ...
    void onPlayerReplyYanjiao(const QList<int> &up_cards, const QList<int> &down_cards);
    ...
    void askForYanjiao(const QVariant &);
...
signals:
    ...
    void yanjiaochoose(const QList<int> &card_ids, const QString &reason, const QString &pattern);
