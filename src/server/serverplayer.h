...
public:
    ...
    void fillHandCards(int n, const QString &reason = QString(), bool from_up = true);
    ...
    QList<PindianStruct *> pindianStructs(QList<ServerPlayer *> targets, const QString &reason, const Card *card1 = NULL);
