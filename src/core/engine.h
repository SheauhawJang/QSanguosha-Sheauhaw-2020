...
public:
    ...
    QStringList getRandomFemaleLords(bool luxun = true, bool zuoci = true) const;
    QStringList getRandomGenerals(int count = 0, const QSet<QString> &ban_set = QSet<QString>(), const QString &kingdom = QString()) const;
    QStringList getRandomFemaleGenerals(int count = 0, const QSet<QString> &ban_set = QSet<QString>(), const QString &kingdom = QString(), bool luxun = true, bool zuoci = true) const;
