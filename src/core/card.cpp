...
{
    return usecontains(card->getEffectiveId());
}
...
void Card::validateAfter(CardUseStruct &card_use) const
{
    validateInResponseAfter(card_use.from, card_use.card);
}

void Card::validateInResponseAfter(ServerPlayer *, const Card *) const
{
